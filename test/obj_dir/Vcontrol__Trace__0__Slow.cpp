...
VL_ATTR_COLD void Vcontrol___024root__trace_init_sub__TOP__0(Vcontrol___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+57,"NumberOfReg", false,-1, 31,0);
...
VL_ATTR_COLD void Vcontrol___024root__trace_full_sub_0(Vcontrol___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+48,((vlSelf->top__DOT__myPC__DOT__PC 
                              + vlSelf->top__DOT__ImmOp)),32);
    bufp->fullIData(oldp+49,(((IData)(4U) + vlSelf->top__DOT__myPC__DOT__PC)),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__myPC__DOT__PC),32);
    bufp->fullIData(oldp+51,(((IData)(vlSelf->top__DOT__PC_src)
                               ? (vlSelf->top__DOT__myPC__DOT__PC 
                                  + vlSelf->top__DOT__ImmOp)
                               : ((IData)(4U) + vlSelf->top__DOT__myPC__DOT__PC))),32);
    bufp->fullSData(oldp+52,(vlSelf->top__DOT__sign_extend__DOT__imm),12);
    bufp->fullBit(oldp+53,(vlSelf->clk));
    bufp->fullBit(oldp+54,(vlSelf->rst));
    bufp->fullBit(oldp+55,(vlSelf->write_en));
    bufp->fullIData(oldp+56,(vlSelf->a0),32);
    bufp->fullIData(oldp+57,(0x20U),32);
    bufp->fullIData(oldp+58,(5U),32);
    bufp->fullBit(oldp+59,(vlSelf->top__DOT__ALU__DOT__ALUsrc));
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__myPC__DOT__next_PC),32);
}
