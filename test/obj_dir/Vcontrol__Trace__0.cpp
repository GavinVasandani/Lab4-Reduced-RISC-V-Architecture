...
void Vcontrol___024root__trace_chg_sub_0(Vcontrol___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+47,((vlSelf->top__DOT__myPC__DOT__PC 
                                 + vlSelf->top__DOT__ImmOp)),32);
        bufp->chgIData(oldp+48,(((IData)(4U) + vlSelf->top__DOT__myPC__DOT__PC)),32);
        bufp->chgIData(oldp+49,(vlSelf->top__DOT__myPC__DOT__PC),32);
        bufp->chgIData(oldp+50,(((IData)(vlSelf->top__DOT__PC_src)
                                  ? (vlSelf->top__DOT__myPC__DOT__PC 
                                     + vlSelf->top__DOT__ImmOp)
                                  : ((IData)(4U) + vlSelf->top__DOT__myPC__DOT__PC))),32);
        bufp->chgSData(oldp+51,(vlSelf->top__DOT__sign_extend__DOT__imm),12);
    }
    bufp->chgBit(oldp+52,(vlSelf->clk));
    bufp->chgBit(oldp+53,(vlSelf->rst));
    bufp->chgBit(oldp+54,(vlSelf->write_en));
