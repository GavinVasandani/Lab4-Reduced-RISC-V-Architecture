...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+3,(((0x13U != (0x7fU & vlSelf->top__DOT__PC_instr)) 
        ...
        bufp->chgBit(oldp+7,((0x13U == (0x7fU & vlSelf->top__DOT__PC_instr))));
        ...
        bufp->chgSData(oldp+11,((vlSelf->top__DOT__PC_instr 
                                 >> 0x14U)),12);
        bufp->chgSData(oldp+12,(((0x800U & (vlSelf->top__DOT__PC_instr 
                                            >> 0x14U)) 
                                 | ((0x400U & (vlSelf->top__DOT__PC_instr 
                                    ...
                                    | ((0x3f0U & (vlSelf->top__DOT__PC_instr 
                                       ...
                                       | (0xfU & (vlSelf->top__DOT__PC_instr 
                                                  >> 8U)))))),12);
        bufp->chgIData(oldp+13,(vlSelf->top__DOT__ALU__DOT__rd1),32);
        bufp->chgIData(oldp+14,(vlSelf->top__DOT__ALU__DOT__rd2),32);
        ...
        bufp->chgIData(oldp+49,((vlSelf->top__DOT__myPC__DOT__PC 
                                 + vlSelf->top__DOT__ImmOp)),32);
        bufp->chgIData(oldp+50,(((IData)(4U) + vlSelf->top__DOT__myPC__DOT__PC)),32);
        bufp->chgIData(oldp+51,(vlSelf->top__DOT__myPC__DOT__PC),32);
        bufp->chgIData(oldp+52,((((0x13U != (0x7fU 
    ...
    bufp->chgBit(oldp+56,(vlSelf->write_en));
