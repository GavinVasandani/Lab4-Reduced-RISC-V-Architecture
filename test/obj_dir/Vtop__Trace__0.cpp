...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgSData(oldp+9,((vlSelf->top__DOT__PC_instr 
                                >> 0x14U)),12);
        bufp->chgSData(oldp+10,(vlSelf->top__DOT__imm_branch),13);
        ...
        bufp->chgIData(oldp+14,(vlSelf->top__DOT__ALU__DOT__dinTest),32);
    ...
    bufp->chgIData(oldp+55,(vlSelf->trash),32);
    bufp->chgIData(oldp+56,(vlSelf->a0),32);
    bufp->chgBit(oldp+57,(vlSelf->wr_en));
    bufp->chgBit(oldp+58,(vlSelf->Eq));
    bufp->chgBit(oldp+59,(vlSelf->alusrc));
    bufp->chgCData(oldp+60,(vlSelf->aluCtrl),3);
    bufp->chgIData(oldp+61,(vlSelf->extout),32);
}
