...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+5,((0x1fU & (vlSelf->top__DOT__PC_instr 
                                         >> 7U))),5);
        bufp->chgBit(oldp+6,((0x13U == (0x7fU & vlSelf->top__DOT__PC_instr))));
        ...
        bufp->chgIData(oldp+13,(vlSelf->top__DOT__ALU__DOT__regFile1__DOT__regFile_array
                                [(0x1fU & (vlSelf->top__DOT__PC_instr 
                                           >> 0x14U))]),32);
        bufp->chgIData(oldp+14,(vlSelf->top__DOT__ALU__DOT__ALUOp2),32);
        bufp->chgIData(oldp+15,(vlSelf->top__DOT__ALU__DOT__dinTest),32);
        ...
        bufp->chgCData(oldp+48,((0x7fU & vlSelf->top__DOT__PC_instr)),7);
        bufp->chgCData(oldp+49,(vlSelf->top__DOT__myPC__DOT__PC),8);
        bufp->chgCData(oldp+50,((0xffU & vlSelf->top__DOT__ImmOp)),8);
        bufp->chgCData(oldp+51,((0xffU & ((IData)(vlSelf->top__DOT__myPC__DOT__PC) 
                                          + vlSelf->top__DOT__ImmOp))),8);
        bufp->chgCData(oldp+52,((0xffU & ((IData)(4U) 
                                          + (IData)(vlSelf->top__DOT__myPC__DOT__PC)))),8);
        bufp->chgCData(oldp+53,((0xffU & (((0x13U != 
                                            (0x7fU 
                                           ...
                                           : ((IData)(4U) 
                                              + (IData)(vlSelf->top__DOT__myPC__DOT__PC))))),8);
        bufp->chgSData(oldp+54,(((0x800U & (vlSelf->top__DOT__PC_instr 
                                            << 4U)) 
                                 | ((0x7e0U & (vlSelf->top__DOT__PC_instr 
                                               >> 0x14U)) 
                                    | (0x1eU & (vlSelf->top__DOT__PC_instr 
    ...
    bufp->chgIData(oldp+57,(vlSelf->trash),32);
    bufp->chgIData(oldp+58,(vlSelf->a0),32);
    bufp->chgBit(oldp+59,(vlSelf->wr_en));
    bufp->chgBit(oldp+60,(vlSelf->Eq));
    bufp->chgBit(oldp+61,(vlSelf->alusrc));
    bufp->chgCData(oldp+62,(vlSelf->aluCtrl),3);
    bufp->chgIData(oldp+63,(vlSelf->extout),32);
}
